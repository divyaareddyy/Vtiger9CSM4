...
public class WebDriverUtility
{
 ...
 /**
  * This method is used to launch specified 
  * @param browser
  * @return
  */
 ...
 public void waitTillElement(long time)
 {
	 driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(time));
 }
 public WebElement explicitWait(long time,WebElement element, WebDriverWait wait)
 {
	wait= new WebDriverWait(driver,Duration.ofSeconds(time));
	return wait.until(ExpectedConditions.visibilityOf(element));
 }
 public WebElement explicitWait(WebElement element,long time, FluentWait<WebDriver> wait)
 {
	 wait= new WebDriverWait(driver,Duration.ofSeconds(time)); 
 ...
 /**
  * This method is used to take the screenshot of the web page and ganerators BASE64 image
  * @return
  */
 ...
 /**
  * This method is handles alert pop up
  * @param status
  */
